...
// чет нихуя не как в фигме
// то что bottomNavigationBar тут это залупа надо его делать в router
//_getbody удаляем и выносим _buildHomeScreen _buildCartScreen в виджеты
// и все названия экранов надо _screen.dart
// перепишешь экранчики еще гляну
                        ...
                        ...filteredCoffee.map(
                          (coffee) => Padding(
                            ...
                            child: CoffeeCard(
                              ...
                              onTap: () {
                                // тут также через роутер делаешь
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
